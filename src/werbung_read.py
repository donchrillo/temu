...
from config import TMP_ORDNER, ORDNER_AUSGANG, ORDNER_LOG



# Logger-Konfiguration
logger = logging.getLogger("werbung_read_logger")
logger.setLevel(logging.INFO)

log_path = ORDNER_LOG / "werbung_read.log"
...
def process_ad_pdfs(directory: Path, output_excel: Path) -> pd.DataFrame:
    """
    Verarbeitet alle Werbe-PDFs im Verzeichnis und exportiert sie als Excel-Datei.

    Args:
        directory (str): Pfad zum Verzeichnis mit einseitigen PDFs.
        output_excel (str): Pfad zur Zieldatei.
...
if __name__ == "__main__":
    process_ad_pdfs(TMP_ORDNER, ORDNER_AUSGANG / "werbung.xlsx")
